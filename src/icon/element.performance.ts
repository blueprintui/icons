...
describe('bp-icon performance', () => {
  ...
  it(`should bundle and treeshake component under 7.5kb`, async () => {
    expect((await testBundleSize('@blueprintui/icons/include.js', { optimize: true })).kb).toBeLessThan(6.75);
  });
  ...
  it(`should render 50 elements under 20ms`, async () => {
    expect((await testRenderTime(element, { iterations: 50 })).duration).toBeLessThan(20);
  });
});
